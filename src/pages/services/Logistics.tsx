...
import { Ship, Truck, Plane, Globe, ArrowRight, CheckCircle2, ShieldCheck, MapPin, BarChart3 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Soluciones de carga completa (FCL) y consolidada (LCL) desde los principales puertos de Asia."
    },
    {
      icon: <Plane className="w-6 h-6" />,
      title: "Flete Aéreo",
      description: "Envíos urgentes y transporte de mercancías de alto valor con tiempos de tránsito optimizados."
    },
    {
      icon: <Truck className="w-6 h-6" />,
      title: "Transporte Terrestre",
      description: "Logística de última milla y distribución local en origen y destino."
    },
    {
      icon: <ShieldCheck className="w-6 h-6" />,
      title: "Gestión Aduanal",
      description: "Asesoría experta en trámites de importación, aranceles y cumplimiento normativo."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Conectividad Global</span>
            </div>
            ...
            <p className="text-xl text-slate-400 max-w-2xl leading-relaxed font-medium mb-12 border-l-2 border-primary/30 pl-8">
              Simplificamos el transporte de sus mercancías desde Asia hasta su almacén, garantizando seguridad y eficiencia en cada milla.
            </p>
            <Link 
              to="/contacto" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-[2px] bg-primary" />
                <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Experiencia</span>
              </div>
              ...
              <div className="space-y-8 text-lg text-slate-500 leading-relaxed font-medium relative">
                ...
                <p className="pl-8">
                  Entendemos que la logística es el corazón de su negocio. Por eso, ofrecemos soluciones integrales que cubren desde la recolección en fábrica hasta el despacho aduanal final, con visibilidad total del proceso.
                </p>
      ...
      <section className="py-32 bg-[#0F0F11] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            ...
            <p className="text-slate-400 font-medium max-w-2xl mx-auto border-t border-white/10 pt-8">Cubrimos todas sus necesidades de transporte internacional.</p>
          </div>
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter italic leading-none mb-12">
            ¿Necesita una <br />
            <span className="text-white/50">Cotización Logística?</span>
          </h2>
          <p className="text-xl text-white/80 font-medium mb-12">
            Optimice sus costos y tiempos de entrega con nuestra red global de transporte. Estamos listos para mover su carga.
          </p>
          <Link 
            to="/contacto" 
          ...
          >
            ...
            <span className="relative z-10">Contactar con Logística</span>
          </Link>
        </div>
      </section>
