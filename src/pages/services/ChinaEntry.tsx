...
import { TrendingUp, Globe, ShoppingBag, Search, CheckCircle2, ArrowRight, BarChart3, Users } from 'lucide-react';
import { Link } from 'react-router-dom';
import { cn } from '@/lib/utils';

export default function ChinaEntry() {
  ...
  const features = [
    {
      ...
      description: "Análisis profundo de competencia, precios y comportamiento del consumidor chino."
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Registro de Marca",
      description: "Protección legal de su propiedad intelectual en territorio chino."
    },
    {
      icon: <ShoppingBag className="w-6 h-6" />,
      title: "E-commerce",
      description: "Estrategia y apertura de tiendas en plataformas como Tmall, JD y Douyin."
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Estrategia de Ventas",
      description: "Desarrollo de canales de distribución y marketing digital local."
    }
  ];

  return (
    <div ref={containerRef} className="min-h-screen flex flex-col bg-[#0F0F11] overflow-hidden">
      <Navbar />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Expansión Global</span>
            </div>
            <h1 className="text-6xl md:text-[8rem] font-black text-white leading-[0.85] mb-12 tracking-tighter uppercase italic">
              Mercado <br />
              <span className="text-primary">Chino</span>
            </h1>
            <p className="text-xl text-slate-400 max-w-2xl leading-relaxed font-medium mb-12 border-l-2 border-primary/30 pl-8">
              Llevamos su marca al mercado de consumo más grande y dinámico del mundo. Estrategias integrales para el éxito de su negocio en Asia.
            </p>
            <Link 
              to="/contacto" 
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-3">
                Solicitar Consultoría <ArrowRight size={14} />
              </span>
            </Link>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-[2px] bg-primary" />
                <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Oportunidades</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter italic leading-none mb-12">
                Venda sus <br />
                <span className="text-primary">Productos en China</span>
              </h2>
              <div className="space-y-8 text-lg text-slate-500 leading-relaxed font-medium relative">
                ...
                <p className="pl-8">
                  El mercado chino ofrece oportunidades sin precedentes para marcas latinoamericanas. Nuestro equipo experto le guía en cada paso, desde la regulación legal hasta la logística de importación y la venta final al consumidor.
                </p>
                <div className="pl-8 space-y-6">
                  {[
                    "Cumplimiento normativo y aduanal", 
                    "Gestión de propiedad intelectual", 
                    "Marketing en redes sociales chinas", 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="w-12 h-[2px] bg-primary" />
              <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Estrategia</span>
              <div className="w-12 h-[2px] bg-primary" />
            </div>
            ...
            <p className="text-slate-400 font-medium max-w-2xl mx-auto border-t border-white/10 pt-8">Estrategias personalizadas para asegurar su posicionamiento en el mercado.</p>
          </div>
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter italic leading-none mb-12">
            ¿Listo para <br />
            <span className="text-white/50">Expandir su Negocio?</span>
          </h2>
          <p className="text-xl text-white/80 font-medium mb-12 leading-relaxed">
            Nuestro equipo experto le guía en cada paso para asegurar su posicionamiento en el mercado más dinámico del mundo.
          </p>
          <Link 
            to="/contacto" 
