...
import { Globe, Languages, Users, MessageSquare, ArrowRight, CheckCircle2, ShieldCheck, MapPin, BarChart3 } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Intérpretes expertos en negocios para sus reuniones, visitas a fábricas y negociaciones."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Acercamiento Cultural",
      description: "Le ayudamos a entender las normas de etiqueta y protocolos de negocios en China."
    },
    {
      icon: <MessageSquare className="w-6 h-6" />,
      title: "Soporte en Negociación",
      description: "No solo traducimos palabras, traducimos intenciones para asegurar el éxito de sus acuerdos."
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Acompañamiento Integral",
      description: "Asistencia en itinerarios, transporte y logística durante su estancia en China."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Puente Cultural</span>
            </div>
            ...
            <p className="text-xl text-slate-400 max-w-2xl leading-relaxed font-medium mb-12 border-l-2 border-primary/30 pl-8">
              Eliminamos las barreras del idioma y la cultura para que sus negocios en China fluyan con total naturalidad y confianza.
            </p>
            <Link 
              to="/contacto" 
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-3">
                Solicitar Intérprete <ArrowRight size={14} />
              </span>
            </Link>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-[2px] bg-primary" />
                <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Comunicación</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter italic leading-none mb-12">
                Más que <br />
                <span className="text-primary">Palabras</span>
              </h2>
              <div className="space-y-8 text-lg text-slate-500 leading-relaxed font-medium relative">
                ...
                <p className="pl-8">
                  En China, los negocios se basan en la confianza y el respeto mutuo (Guanxi). Nuestros intérpretes no solo dominan el idioma, sino que son expertos en la cultura de negocios local, ayudándole a navegar situaciones complejas y cerrar acuerdos exitosos.
                </p>
                <div className="pl-8 space-y-6">
                  {[
                    "Intérpretes nativos y bilingües", 
                    "Especialistas en terminología técnica", 
                    "Asesoría en protocolo y etiqueta", 
                    "Acompañamiento en viajes de negocios"
                  ].map((item, i) => (
      ...
      <section className="py-32 bg-[#0F0F11] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            ...
            <p className="text-slate-400 font-medium max-w-2xl mx-auto border-t border-white/10 pt-8">Le acompañamos en cada interacción para asegurar que su mensaje llegue con claridad.</p>
          </div>
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter italic leading-none mb-12">
            ¿Necesita un <br />
            <span className="text-white/50">Intérprete en China?</span>
          </h2>
          <p className="text-xl text-white/80 font-medium mb-12">
            Asegure el éxito de sus negociaciones con el apoyo de expertos en idioma y cultura local.
          </p>
          <Link 
            to="/contacto" 
          ...
          >
            ...
            <span className="relative z-10">Solicitar Asistencia</span>
          </Link>
        </div>
      </section>
