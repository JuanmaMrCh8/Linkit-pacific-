...
import { Search, ShieldCheck, Ship, TrendingUp, Check, ShoppingBag, ArrowRight, CheckCircle2, Globe, BarChart3, Users, Box } from 'lucide-react';
...
export default function Sourcing() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Validación de Fábricas",
      description: "Auditamos las instalaciones y licencias legales de sus potenciales proveedores."
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Negociación de Precios",
      description: "Obtenemos las mejores condiciones comerciales gracias a nuestro equipo local en China."
    },
    {
      icon: <Box className="w-6 h-6" />,
      title: "Desarrollo de Productos",
      description: "Soporte integral en proyectos OEM/ODM y gestión de muestras personalizadas."
    }
  ];
    ...
    <div ref={containerRef} className="min-h-screen flex flex-col bg-white overflow-hidden">
      ...
      <section className="relative pt-48 pb-32 bg-[#0F0F11] overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-30">
          <img 
            src="https://images.unsplash.com/photo-1566576912902-48f6d932843c?q=80&w=2070&auto=format&fit=crop" 
            alt="Sourcing China" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Sourcing Estratégico</span>
            </div>
            <h1 className="text-6xl md:text-[8rem] font-black text-white leading-[0.85] mb-12 tracking-tighter uppercase italic">
              Proveedores <br />
              <span className="text-primary">en Asia</span>
            </h1>
            <p className="text-xl text-slate-400 max-w-2xl leading-relaxed font-medium mb-12 border-l-2 border-primary/30 pl-8">
              Eliminamos las barreras de idioma y cultura para conectar su negocio con fabricantes confiables y competitivos en China.
            </p>
            <Link 
              to="/contacto" 
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-3">
                Iniciar Búsqueda <ArrowRight size={14} />
              </span>
            </Link>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-[2px] bg-primary" />
                <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Su Oficina</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black text-slate-900 uppercase tracking-tighter italic leading-none mb-12">
                Presencia <br />
                <span className="text-primary">en China</span>
              </h2>
              <div className="space-y-8 text-lg text-slate-500 leading-relaxed font-medium relative">
                ...
                <p className="pl-8">
                  No solo buscamos proveedores; construimos relaciones sólidas y seguras para su cadena de suministro. Nuestro equipo local en Shenzhen valida cada detalle para que usted solo se preocupe por vender.
                </p>
                <div className="pl-8 space-y-6">
                  {[
                    "Acceso a bases de datos exclusivas", 
                    "Negociación en idioma local", 
                    "Validación de certificaciones internacionales", 
                    "Gestión integral de muestras"
                  ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="w-12 h-[2px] bg-primary" />
              <span className="text-primary font-black tracking-[0.3em] uppercase text-xs">Capacidades</span>
              <div className="w-12 h-[2px] bg-primary" />
            </div>
            ...
            <p className="text-slate-400 font-medium max-w-2xl mx-auto border-t border-white/10 pt-8">Soluciones integrales para cada etapa de su proceso de compra.</p>
          </div>
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter italic leading-none mb-12">
            ¿Busca el <br />
            <span className="text-white/50">Proveedor Ideal?</span>
          </h2>
          <p className="text-xl text-white/80 font-medium mb-12 leading-relaxed">
            Eliminamos las barreras y conectamos su negocio con fabricantes confiables en Asia. Inicie su búsqueda hoy mismo.
          </p>
          <Link 
            to="/contacto" 
          ...
          >
            ...
            <span className="relative z-10">Iniciar Búsqueda Estratégica</span>
          </Link>
        </div>
      </section>
